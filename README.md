...
3. Select **Browse**, search for **Journal Bases**, install it, then enable it.
...
1. Download `main.js`, `manifest.json`, and `styles.css` from the [latest release](https://github.com/dsebastien/obsidian-journal-base/releases).
2. Copy them into `<Vault>/.obsidian/plugins/journal-bases/`.
3. Reload Obsidian and enable **Journal Bases** in **Settings → Community plugins**.
...
3. Paste `https://github.com/dsebastien/obsidian-journal-base`.
4. Select the latest version and confirm.
5. Enable **Journal Bases** in **Settings → Community plugins**.
